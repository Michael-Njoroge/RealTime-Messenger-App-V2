...
class MessageController extends Controller
{
    ...
    {
        //load older messages that are older that the given message & sort by latest
        if($message->group_id){
            $messages = Message::where('created_at', '<', $message->created_at)->where('group_id', $message->group_id)->latest()->paginate(10);
        }else{
