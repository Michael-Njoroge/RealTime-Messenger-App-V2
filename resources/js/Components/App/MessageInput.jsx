...
const MessageInput = ({conversation = null}) => {
    ...
    return (
        <div className="flex flex-wrap items-start border-t border-slate-700 py-3">
            ...
            <div className="order-1 px-3 xs:p-0 min-w-[240px] basis-full xs:basis-0 xs:order-2 flex-1 relative">
                <div className="flex">
            ...
            <div className="order-3 xs:order-3 p-2 flex">
                ...
                <button onClick={onLikeClick} className="p-1 text-gray-400 hover:text-red-300">
